...
var renderDemoAuto = function() {

renderDemo();
ny=setTimeout(renderDemoAuto, 200);
document.getElementById("reloadauto").innerHTML='<u><a href="#" onclick="stop()">&#8635; Stop Animation</a></u>';
 
};

var stop=function()
{
document.getElementById("reloadauto").innerHTML='<u><a href="#" onclick="renderDemoAuto()">&#8635; Start Animation</a></u>';
clearTimeout(ny);
}
